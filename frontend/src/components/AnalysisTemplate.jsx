...
function AnalysisTemplate({
  ...
  // Rastgele parçacıklar oluştur (memoize et, her renderda değişmesin)
  const parcaciklar = useMemo(() => {
    return Array.from({ length: 18 }, (_, i) => ({
      ...
      isSembol: i < 5, // İlk 5'i coin sembolü, geri kalanı daire
    }))
  }, [])
  ...
  return (
    ...
    >
      ...
      {/* Watermark - Büyük Soluk Coin İkonu */}
      <div
        className="coin-watermark"
        style={{ color: coinRenk }}
      >
        {coinSembol}
      </div>
